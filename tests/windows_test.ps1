...
try {
    ...
    if ($LASTEXITCODE -ne 0 -or $version.Count -ne 2 -or $version[0] -ne 'ferri version 0.1.2 (2026-09-07)' -or $version[1] -ne 'https://github.com/leo1394/homebrew-ferri') { throw 'Windows launcher failed' }
